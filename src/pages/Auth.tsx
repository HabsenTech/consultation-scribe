...
// Check if running on Lovable domain (where managed OAuth works)
const isLovableDomain = () => {
  const hostname = window.location.hostname;
  return hostname.endsWith('.lovable.app') || 
         hostname.endsWith('.lovableproject.com') ||
         hostname === 'localhost'; // Disable OAuth on localhost too
};
...
const Auth = () => {
  ...
  // Only show Google OAuth on Lovable-hosted domains
  const showGoogleAuth = useMemo(() => isLovableDomain(), []);
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin}>
                <CardContent className="space-y-4">
                  ...
                  {/* Google Sign In Button - only on Lovable domains */}
                  {showGoogleAuth && (
                    <>
                      <Button
                        type="button"
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignup}>
                <CardContent className="space-y-4">
                  ...
                  {/* Google Sign Up Button - only on Lovable domains */}
                  {showGoogleAuth && (
                    <>
                      <Button
                        type="button"
